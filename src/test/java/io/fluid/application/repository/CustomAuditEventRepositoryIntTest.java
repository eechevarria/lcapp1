package io.fluid.application.repository;

import io.fluid.application.Lcapp1App;
import io.fluid.application.config.Constants;
import io.fluid.application.config.audit.AuditEventConverter;
import io.fluid.application.domain.PersistentAuditEvent;
...
import static io.fluid.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
