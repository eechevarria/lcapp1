package io.fluid.application.web.rest;

import io.fluid.application.config.Constants;
import io.fluid.application.Lcapp1App;
import io.fluid.application.domain.Authority;
import io.fluid.application.domain.PersistentToken;
import io.fluid.application.domain.User;
import io.fluid.application.repository.AuthorityRepository;
import io.fluid.application.repository.PersistentTokenRepository;
import io.fluid.application.repository.UserRepository;
import io.fluid.application.security.AuthoritiesConstants;
import io.fluid.application.service.MailService;
import io.fluid.application.service.dto.UserDTO;
import io.fluid.application.web.rest.errors.ExceptionTranslator;
import io.fluid.application.web.rest.vm.KeyAndPasswordVM;
import io.fluid.application.web.rest.vm.ManagedUserVM;
import io.fluid.application.service.UserService;
...
@SpringBootTest(classes = Lcapp1App.class)
